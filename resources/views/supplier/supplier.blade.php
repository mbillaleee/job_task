                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <label style="padding-left:90px">Name *</label>&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-group">
                                <label style="padding-left:25px"> Company Name *</label>&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-group">
                                <label style="padding-left:65px"> Mobile No *</label>&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-group">
                                <label style="padding-left:79px">Address *</label>&nbsp;&nbsp;&nbsp;
                            ...
                            @if ($supplier)
                            <div class="form-group">
                                <label style="padding-left:79px">Opening due *</label>&nbsp;&nbsp;&nbsp;
                                <div class="form-check-inline col-sm-10">
                            ...
                            <div class="form-group">
                                <label style="padding-left:89px">Status *</label>&nbsp;&nbsp;&nbsp;
